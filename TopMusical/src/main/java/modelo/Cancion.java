...
public class Cancion implements Comparable<Cancion> {
    ...
    public Cancion(String titulo, String cantante, String imagen, int posPrevia, int semanas, List<Integer> historialPos, int posActual) {
        this.titulo = titulo;
    ...
    public static ArrayList<Cancion> leerCanciones() {
        ...
        try ( BufferedReader br = new BufferedReader(new FileReader("top10_american_songs.csv"))) {
            String linea = "";
            while ((linea = br.readLine()) != null) {
                ...
                Cancion c = new Cancion(datos[0], datos[1], datos[2], Integer.valueOf(datos[4]), Integer.valueOf(datos[5]),  listaHistorial, Integer.valueOf(datos[3]));
                lista.add(c);
            }
